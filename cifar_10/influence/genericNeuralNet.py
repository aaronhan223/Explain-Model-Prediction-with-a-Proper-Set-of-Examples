...
class GenericNeuralNet(object):
    ...
    def loss(self, logits, labels):
        ...
        # labels = tf.ones(tf.shape(temp), dtype=tf.float32) / self.num_classes
    ...
    def adversarial_loss(self, logits, labels):
        ...
        indiv_adversarial_loss = tf.reduce_logsumexp(wrong_logits, reduction_indices=1) - tf.reduce_logsumexp(logits,
                                                                                                              reduction_indices=1)
